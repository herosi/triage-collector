 ...
 *
 * https://github.com/clymb3r/PowerShell/blob/master/Invoke-NinjaCopy/NTFSParser/NTFSParserDLL/NTFS_Attribute.h
 *
...
CDataRunList *CAttrNonResident::GetDataRunList()
{
	return &DataRunList;
}
